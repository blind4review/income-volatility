...
TICs.m1<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + HSeduc + married
TICs.m2<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink #these can be baseline proxies for health status?
TICs.m3<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
...
table(sensdata$sex)
#income volatility (SD of pct change over time)
TICs.m1<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + raceth + HSeduc + married
TICs.m2<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + raceth + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink #these can be baseline proxies for health status?
TICs.m3<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + raceth + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
...
#income volatility (SD of pct change over time)
TICs.m1<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + HSeduc + married
TICs.m2<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink #these can be baseline proxies for health status?
TICs.m3<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
...
#output results table
  #write.csv(racesexmod,"/Users/xxxx/Pooling Projects/Income Pooling/NLSY replicate Grasset et al/results/racesexmod_zscore.csv")
...
#income volatility (SD of pct change over time)
TICs.m1<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth + HSeduc + married
TICs.m2<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink #these can be baseline proxies for health status?
TICs.m3<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
...
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + everpov + sd_incvol*everpov + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
pov.inxn <- lm(TICs.m3.inxn, data = sensdata)
summary(pov.inxn)
    
m01  <- lm(TICSm.zscore ~ sd_incvol + everpov + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + everpov + sd_incvol*everpov + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
anova(m01, m02)        
...
#statistical test for interaction
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + low.wealth + sd_incvol*low.wealth + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
lw.inxn <- lm(TICs.m3.inxn, data = sensdata)
    summary(lw.inxn)  

m01  <- lm(TICSm.zscore ~ sd_incvol + low.wealth + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + low.wealth + sd_incvol*low.wealth + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
anova(m01, m02)        
...
#statistical test for interaction
sensdata$p2000assets.n<-ifelse(sensdata$p2000assets.c=="always",0,
                              ifelse(sensdata$p2000assets.c=="sometimes",1,2))
table(sensdata$p2000assets.n,sensdata$p2000assets.c)

TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + p2000assets.n + sd_incvol*p2000assets.n + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
passet.inxn <- lm(TICs.m3.inxn, data = sensdata)
  summary(passet.inxn)  
    
m01  <- lm(TICSm.zscore ~ sd_incvol + p2000assets.c + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + p2000assets.c + sd_incvol*p2000assets.c + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
anova(m01, m02)        
...
#statistical test for interaction   
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + neverhome + sd_incvol*neverhome + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
home.inxn <- lm(TICs.m3.inxn, data = sensdata)
    summary(home.inxn)  

m01  <- lm(TICSm.zscore ~ sd_incvol + neverhome + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + neverhome + sd_incvol*neverhome + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
  anova(m01, m02)        
...
edTICs.m1<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth + married
edTICs.m2<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink #these can be baseline proxies for health status?
edTICs.m3<-TICSm.zscore ~ sd_incvol + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
...
#statistical test for interaction   
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + HSeduc + sd_incvol*HSeduc + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
ed.inxn <- lm(TICs.m3.inxn, data = sensdata)
  summary(ed.inxn)  
 
m01  <- lm(TICSm.zscore ~ sd_incvol + HSeduc + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + HSeduc + sd_incvol*HSeduc + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
  anova(m01, m02)        
...
#statistical test for interaction   
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + income90.class + sd_incvol*income90.class + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
ic90.inxn <- lm(TICs.m3.inxn, data = sensdata)
  summary(ic90.inxn)  
    
m01  <- lm(TICSm.zscore ~ sd_incvol + as.factor(income90.class) + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + as.factor(income90.class) + sd_incvol*as.factor(income90.class) + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
  anova(m01, m02)        
...
#statistical test for interaction   
TICs.m3.inxn<-TICSm.zscore ~ sd_incvol + avg90income.class + sd_incvol*avg90income.class + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2
icavg.inxn <- lm(TICs.m3.inxn, data = sensdata)
  summary(icavg.inxn)  
 
m01  <- lm(TICSm.zscore ~ sd_incvol + as.factor(avg90income.class) + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
m02  <- lm(TICSm.zscore ~ sd_incvol + as.factor(avg90income.class) + sd_incvol*as.factor(avg90income.class) + CogTestYear + AFQTpctlscore06rev.81.r + sumincomes + age.1990 + sex + raceth +  HSeduc + married + BMI1990.ht1985 + smokstat92 + depressed92 + ephealthins + heavydrink + eqincome90.1990 + empstat2, data=sensdata)
  anova(m01, m02)        
  
#output results table
  #write.csv(financialmod,"/Users/xxxx/Pooling Projects/Income Pooling/NLSY replicate Grasset et al/results/financialmod_zscore.csv")
